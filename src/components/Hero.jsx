...
export default function Hero({ user }) {
  return (
    <div className="relative overflow-hidden bg-card-dark rounded-3xl border border-border-dark/50 p-8 md:p-12 mb-8 shadow-gallery">
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
        <div className="flex-1 space-y-6 text-center md:text-left">
          <div className="animate-in slide-in-from-left duration-700">
            <h1 className="text-4xl md:text-5xl font-bold text-transparent bg-linear-to-t from-muted-grey to-white bg-clip-text mb-2 leading-tight">
              Welcome back,{" "}
            ...
            <p className="text-muted-grey text-lg max-w-xl font-medium leading-relaxed">
